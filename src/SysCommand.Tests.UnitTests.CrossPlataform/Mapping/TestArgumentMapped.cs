...
namespace SysCommand.Tests.UnitTests
{
    public class TestArgumentMapped
    {
        ...
        private void TestArgsMappedAuto(string mapMethodName, string input, bool enablePositionedArgs, string testMethodName)
        {
            ...
            var maps = CommandParserUtils.GetArgumentsMapsFromMethod(obj, method);
        ...
        public void MethodInvalidShortName()
        {
            ...
            {
                Assert.True(ex.Message == "The map 'v1' has 'ShortName' invalid in method or class 'Method11'");
            }
        }
        ...
        public void MethodInvalidLongNameEmpty()
        {
            ...
            {
                Assert.True(ex.Message == "The map 'v1' has 'LongName' invalid in method or class 'Method12'");
            }
        }
        ...
        public void MethodInvalidShortNameEmpty()
        {
            ...
            {
                Assert.True(ex.Message == "The map 'v1' has 'ShortName' invalid in method or class 'Method13'");
            }
        }
        ...
        public void MethodDuplicateShortName()
        {
            ...
            {
                Assert.True(ex.Message == "The map 'v1' has the same 'ShortName' on the map 'v2' in method or class 'Method14'");
            }
        }
        ...
        public void MethodDuplicateLongName()
        {
            ...
            {
                Assert.True(ex.Message == "The map 'v1' has the same 'LogName' on the map 'v2' in method or class 'Method15'");
            }
        }
