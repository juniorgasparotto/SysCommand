...
namespace SysCommand.Tests.UnitTests
{
    ...
    public class TestAction
    {
        private void TestActionMapped(IEnumerable<ActionMap> actionMaps, string input, bool enableMultiAction, string testMethodName)
        {
            ...
            var actionsMapped = CommandParserUtils.ParseActionMapped(argsRaw, enableMultiAction, actionMaps, out initialExtraArguments);
        ...
        {
            var actionMaps = CommandParserUtils.GetActionsMapsFromSourceObject(new Git(), onlyWithAttribute: true, usePrefixInAllMethods: false, prefix: "custom-prefix");
        ...
        {
            var actionMaps = CommandParserUtils.GetActionsMapsFromSourceObject(new Git(), onlyWithAttribute: false, usePrefixInAllMethods: true, prefix: null);
        ...
        {
            var actionMaps = CommandParserUtils.GetActionsMapsFromSourceObject(new Git(), onlyWithAttribute: false, usePrefixInAllMethods: true, prefix: "custom-prefix");
        ...
        {
            var actionMaps = CommandParserUtils.GetActionsMapsFromSourceObject(new Git(), onlyWithAttribute: false, usePrefixInAllMethods: false, prefix: null);
            this.TestActionMapped(actionMaps, CommandParserUtils.MAIN_METHOD_NAME, true, TestHelper.GetCurrentMethodName());
        }
